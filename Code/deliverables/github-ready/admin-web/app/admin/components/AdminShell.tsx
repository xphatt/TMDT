...
export function AdminShell({
  ...
  return (
    <div className="admin-shell" data-design-contract={DESIGN_CONTRACT}>
      ...
      <aside className={`admin-sidebar ${menuOpen ? "is-open" : ""}`} aria-label="Điều hướng quản trị">
        ...
        <nav>
          ...
          <a href={storefrontUrl} target="_blank" rel="noreferrer">Mở cửa hàng</a>
        </nav>
      ...
      {menuOpen && <button className="admin-menu-scrim" type="button" aria-label="Đóng menu" onClick={() => setMenuOpen(false)} />}
    </div>
  );
}
