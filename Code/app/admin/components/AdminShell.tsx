...
export function AdminShell({
  ...
  active: "dashboard" | "orders" | "catalogue" | "feedback" | "reviews";
    ...
    <div className="admin-shell" data-design-contract={DESIGN_CONTRACT}>
      ...
      <aside ref={sidebarRef} className={`admin-sidebar ${menuOpen ? "is-open" : ""}`} id="admin-navigation" aria-label="Điều hướng quản trị">
        ...
        <nav>
          ...
          <a className={active === "catalogue" ? "is-active" : ""} href="/admin/catalogue" aria-current={active === "catalogue" ? "page" : undefined}>Catalogue</a>
          <a className={active === "feedback" ? "is-active" : ""} href="/admin/feedback" aria-current={active === "feedback" ? "page" : undefined}>Phản hồi</a>
          <a className={active === "reviews" ? "is-active" : ""} href="/admin/reviews" aria-current={active === "reviews" ? "page" : undefined}>Đánh giá</a>
