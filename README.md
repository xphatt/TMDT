...
•	Chọn phương thức thanh toán: Thanh toán khi nhận hàng; Chuyển khoản/QR mô phỏng.
...
[Tên thành viên 1]	Frontend	Giao diện và responsive
[Tên thành viên 2]	Frontend	Sản phẩm, giỏ hàng
[Tên thành viên 3]	Backend	API và dữ liệu
[Tên thành viên 4]	Backend	Đơn hàng, thanh toán
[Tên thành viên 5]	UI/UX	Thiết kế giao diện
[Tên thành viên 6]	QA	Kiểm thử và tài liệu
License
